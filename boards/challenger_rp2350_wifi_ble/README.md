Challenger rp2350 WIFI BLE
==========================
![alt text](image.png)
<img src="https://i0.wp.com/ilabs.se/wp-content/uploads/2024/08/challenger-rp2350-wifi-ble-prpi-iso1-small.jpg?resize=1024%2C768&ssl=1

Card information (https://ilabs.se/challenger-rp2350-wifi-ble)
The [Raspberry Pi Pico2](https://www.raspberrypi.org/products/raspberry-pi-pico2/) is a
