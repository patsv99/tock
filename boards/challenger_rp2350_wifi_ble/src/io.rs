...
impl Writer {
    ...
    fn configure_uart(&self, uart: &Uart) {
        if !uart.is_configured() {
            ...
            let gpio_tx = RPGpioPin::new(RPGpio::GPIO12);
            let gpio_rx = RPGpioPin::new(RPGpio::GPIO13);
...
pub unsafe fn panic_fmt(pi: &PanicInfo) -> ! {
    // LED is connected to GPIO 07

    use core::ptr::{addr_of, addr_of_mut};
    let led_kernel_pin = &RPGpioPin::new(RPGpio::GPIO7);
