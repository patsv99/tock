...
//! SyscallDriver for RP2350 ADC MCU temperature sensor
...
pub struct TemperatureRp2350<'a, A: adc::AdcChannel<'a>> {
    adc: &'a A,
    slope: f32,
    v_27: f32,
...
impl<'a, A: adc::AdcChannel<'a>> TemperatureRp2350<'a, A> {
    /// slope - device specific slope found in datasheet
    /// v_27 - voltage at 27 degrees Celsius found in datasheet
    pub fn new(adc: &'a A, slope: f32, v_27: f32) -> TemperatureRp2350<'a, A> {
        TemperatureRp2350 {
            adc,
            slope,
            v_27,
...
impl<'a, A: adc::AdcChannel<'a>> adc::Client for TemperatureRp2350<'a, A> {
...
impl<'a, A: adc::AdcChannel<'a>> sensors::TemperatureDriver<'a> for TemperatureRp2350<'a, A> {
